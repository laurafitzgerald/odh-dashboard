...
import { PyTorchJobKind, RayJobKind } from '../../k8sTypes';
import { PyTorchJobState, RayJobState, TrainingJobState } from '../../types';
import { getWorkloadForPyTorchJob, getWorkloadForRayJob } from '../../api';
...
// Generic type and functions that work with all job types
export type TrainingJob = PyTorchJobKind | RayJobKind;
